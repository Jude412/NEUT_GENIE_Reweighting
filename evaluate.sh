...
python evaluate.py \
    ...
    --original_test '/vols/dune/jmm224/t2knova/reweighting/saved_samples/6D_5DMode_v2_1/all/original_test.csv' \
    --target_test_nD '/vols/dune/jmm224/t2knova/reweighting/saved_samples/6D_5DMode_v2_1/6D/target_test.csv' \
    --target_test '/vols/dune/jmm224/t2knova/reweighting/saved_samples/6D_5DMode_v2_1/all/target_test.csv' \
    ...
    --swd_distribution_target_all '/vols/dune/jmm224/t2knova/reweighting/saved_swd_distribution/6D_5DModev2_modev2_1/all/swd_distribution_all.npy' \
